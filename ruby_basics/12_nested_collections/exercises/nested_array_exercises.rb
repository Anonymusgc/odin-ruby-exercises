def blank_seating_chart(number_of_rows, seats_per_row)
  ...
  # change with it
  array = Array.new(number_of_rows) { Array.new(seats_per_row, nil) }
end
...
def count_empty_seats(chart)
  ...
  chart
    .flatten
    .reduce(0) do |empty_seats, seat|
      seat.nil? ? empty_seats += 1 : empty_seats
    end
end
...
def find_favorite(array_of_hash_objects)
  ...
  array_of_hash_objects.reduce do |acc, obj|
    return acc = obj if obj.dig(:is_my_favorite?)
  end
end
